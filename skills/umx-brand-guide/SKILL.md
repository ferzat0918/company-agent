...
| 企业核心身份/定位/价值观/组织架构与职责边界/产品线总览 | 读 `references/brand.md` |
...
## 企业核心身份与品牌知识库 — `references/brand.md`

该文件包含了完整的品牌核心战略、价值观、组织职责及产品线知识库，包括以下核心板块：
1. **企业核心身份**：公司/品牌名称、一句话定位、我们是谁/我们不是谁（不是传统家具、不是普通铝材、不是电竞品牌，而是介于家具与消费电子之间的情绪硬件系统）。
2. **品牌灵魂与视觉语言**：冷硬结构与情绪光场。
3. **文案绝对禁用词与替换指南**：严格禁用全网第一、天花板、封神、高级感拉满、氛围感拉满、黑科技、轻奢、尊贵、匠心、闭眼入、买它、绝绝子等。
4. **组织架构与部门边界**：CEO、品牌部、产品研发部、市场营销部、内容部、交付部、海外DTC、AI先锋小组的具体工作范围与协同分工。
5. **产品线与资料模板**：系统桌（控制台）、系统电视支架（TV STAND 65"/75" bounds）、系统柜、音响落地灯、感应椅、床靠背等产品定位、完成度及产品要素表。
